...
/// </typeparam>
public sealed partial record QueryOperator<TRecordset, TReturn>(QueryHandler ChainHandler, CompositeQuery<TRecordset, TReturn> Composite, List<IDictionary<string, object>> InputData) : ICompositeQueryOperations<TRecordset, TReturn>;
